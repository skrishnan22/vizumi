...
[What is possible](https://medium.com/@jaykreps/exactly-once-support-in-apache-kafka-55e1fdd0a35f) though is _exactly-once processing_. By adding a unique idempotency key to each message, you can enable consumers to recognize and ignore duplicate messages, i.e. messages which they have received and successfully processed before.
...
![Gunnar Morling](https://www.morling.dev/images/gunnar_morling.jpg)
...
#### [5 reactions](https://github.com/gunnarmorling/discussions.morling.dev/discussions/338)

👍5

#### [0 comments](https://github.com/gunnarmorling/discussions.morling.dev/discussions/338)
...
[Sign in with GitHub](https://giscus.app/api/oauth/authorize?redirect_uri=https%3A%2F%2Fwww.morling.dev%2Fblog%2Fon-idempotency-keys%2F)