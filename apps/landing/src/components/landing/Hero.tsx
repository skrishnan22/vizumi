        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 sm:space-y-8">
            ...
            <motion.h1
              ...
              className="text-5xl sm:text-6xl md:text-7xl lg:text-[5.5rem] font-display font-semibold leading-[0.95] tracking-tight text-blue-600 drop-shadow-sm"
            >
              From URL <span className="text-blue-600/40 font-light">to</span>
              <br />
