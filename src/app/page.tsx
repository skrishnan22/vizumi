...
export default function Home() {
  return (
    <main className="min-h-screen bg-neutral-50 selection:bg-yellow-200 font-sans">
      {/* Background Pattern */}
      <div className="fixed inset-0 -z-10 h-full w-full bg-white [background:radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:24px_24px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]"></div>
        ...
        <header className="flex flex-col md:flex-row items-center justify-between gap-12 mb-24">
          <div className="max-w-2xl z-10">
            ...
            <p className="text-xl text-gray-600 leading-relaxed mb-10 max-w-xl">
              Turn any dense article into an interactive study board.
              Visualize concepts, map connections, and master new topics faster than ever.
            </p>
          ...
          <div className="relative w-full max-w-xl hidden md:block">
            <div className="absolute inset-0 bg-gradient-to-tr from-gray-100/40 to-white/40 blur-3xl rounded-full"></div>
            <HeroAnimation />
          </div>
        </header>
